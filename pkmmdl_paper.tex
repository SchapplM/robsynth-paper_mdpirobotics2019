...
\begin{figure}[h!]
	...
	\vspace{-0.4cm}	% Damit Fu√ünote von unten n√§her an das Bild heranr√ºckt
    \vspace{-0.5cm} % TODO: Remove after removing the text before changes
\end{figure} 
\newpage
%
...
The parallel robots with five DoF presented above have a kinematic \todo[color=green!40]{Language}structure\deleted[id=Sp]{,} that allows for an analytic model of the inverse kinematics.
...
%\vspace{-0.5cm} % Damit Fig. 3 auf der Seite bleibt
...
\vspace{-0.6cm} % TODO: Wieder entfernen nach Entfernen der alten Textstellen
...
\begin{figure}[H]
    ...
    \caption{Overview of the different frames (a) for six-DoF tasks with standard Euler angle \replaced[id=Sp]{convention}{notation} and (b) for five-DoF tasks with reciprocal Euler angle \replaced[id=Sp]{convention}{notation}; taken from \cite{1_SchapplerTapOrt2019}.}
...
%\vspace{12pt}  %vertical spacing (enlarge 12pt)
\begin{figure}[H]
...
%		\begin{minipage}[t]{7.5cm}
%			\vspace{0.001cm} % wird f√ºr bounding box des Bilds ben√∂tigt
%			\hspace{1cm}
...
\newblock  \hl{In Proceedings of the International Conference on Integrated Design and Manufacturing in Mechanical Engineering, At Montreal, Canada, 16--19 May  2000}.}%Newly added information, please confirm.
...
\newblock  In Proceedings of the Robotics research: the first international symposium, Cambridge, MA, USA, \hl{day month}1984; pp. 735--747.%Please add the date of conference.
...
Gogu, G.
\newblock Solid Mechanics and Its Applications. In {\em Structural Synthesis of Parallel Robots, Part 1: Methodology}; Springer: Berlin, Germany; \hl{Years}, Volume 866.%Please add the year of the book
...
Bär, G.F.; Weiß, G.
\newblock \hl {Kinematic Analysis of a Pentapod Robot.}
\newblock {\em J. Geom. Graphics} {\bf 2006}. %Is it a journal? if so, please add the voluem and page, if not, it's better to modify as an online resource. Please provide the URL address and the accessed date (day month year)
...
\newblock  In Proceedings of the ASME International Design Engineering Technical Conferences and Computers and Information in Engineering Conference, \hl{city, country, conference date;} pp. 1335--1344.% Please add the city, country and date fo conference.
\newblock
...
\newblock \hl{Automatic generation of a minimal set of serial mechanisms for a
  combined structural - geometrical synthesis.}
\newblock  Proc. of the 14th IFToMM World Congress; ,  2015.
\newblock
  doi:{\changeurlcolor{black}\href{https://doi.org/10.6567/IFToMM.14TH.WC.OS13.047}{\detokenize{10.6567/IFToMM.14TH.WC.OS13.047}}}.% Is it a conference paper? if so, please add the information of conference, if not, it's better to modify as an online resource. Please provide the URL address and the accessed date (day month year)
