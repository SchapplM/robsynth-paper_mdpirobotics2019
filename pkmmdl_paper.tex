...
Further, ssing $\bm{\Psi}$/$\bm{\eta}$ as elaborated above allows for the first time to define differential kinematics specifically for 3T2R tasks in a general form.
