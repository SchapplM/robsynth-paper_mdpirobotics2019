...
Each bar represents the stacked relative frequency of the IK result state in percent for one robot.
The result state is defined as the number of tries or the success.
All bars add up to 100\,\%, which corresponds to the 2500 configurations per robot.
