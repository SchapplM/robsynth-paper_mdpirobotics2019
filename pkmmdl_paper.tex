...
The redundancy can be exploited by using the Nullspace projection ${\Delta}\bm{q}_{\mathrm{N}}$ from \cite{Yoshikawa1984} additionally to the solution ${\Delta}\bm{q}_{\mathrm{T}}$ of the IKP with the increment
%
\begin{equation}
{\Delta}\bm{q}^{k}
=
