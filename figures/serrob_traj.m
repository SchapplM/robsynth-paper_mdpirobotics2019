...
leghdl = legend(leglinhdl([1:3,4,7]), ...
  {sprintf('$\\phi_z=%1.0f^\\circ$', 180/pi*value_axori(ii_Ausw(1))), ...
   sprintf('$\\phi_z=%1.0f^\\circ$', 180/pi*value_axori(ii_Ausw(2))), ...
   sprintf('$\\phi_z=%1.0f^\\circ$', 180/pi*value_axori(ii_Ausw(3))), ...
