...
\end{equation}
%
can be used to test the implementation, if (\ref{equ:alpha_xyz_diff_R}, \ref{equ:rotmat_diff_beta}) are defined for the same \todo[color=green!40]{Hyphenation}Euler\replaced[id=Sp]{ }{-}lock\replaced[id=Sp]{ }{-}angle \todo[color=red!40]{Terminology}\replaced[id=Sp]{convention}{notation}.
