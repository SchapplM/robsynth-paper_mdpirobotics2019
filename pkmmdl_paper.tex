...
\Title{Modeling Parallel Robots for 3T2R and 3T3R Tasks using Reciprocal Sets of Euler Angles}
...
\Author{Moritz Schappler $^{1,\dagger,\ddagger}$\orcidA{}, Svenja Tappe $^{1,\ddagger}$ and Tobias Ortmaier $^{1,}$*}
...
\address{%
$^{1}$ \quad Institut für mechatronische Systeme, Leibniz Universität Hannover; moritz.schappler@imes.uni-hannover.de\\
$^{2}$ \quad Affiliation 2; e-mail@e-mail.com}

% Contact information of the corresponding author
\corres{Correspondence: moritz.schappler@imes.uni-hannover.de; Tel.: (optional; include country code; if there are multiple corresponding authors, add author initials) +xx-xxxx-xxx-xxxx (F.L.)}
