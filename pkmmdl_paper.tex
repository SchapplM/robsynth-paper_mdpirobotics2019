...
%\usepackage[disable]{todonotes} % Für finale Version ohne Änderungen
% Markup package
\usepackage[deletedmarkup=xout,authormarkup=none]{changes}
%\usepackage[final]{changes} % Für finale Version ohne Änderungen
...
%
\begin{figure}[b]
    \vspace{-0.5cm} % Bild näher von unten an Fußnote heranbringen
...
% Einstellungen für diesen Versuch, siehe figures/serrob_traj.m
...
%
\begin{figure}[b]
	\vspace{-0.5cm} % Näher von unten an Fußnote heranrücken.
