...
\todo[color=green!40]{Language}Therefore\added[id=Sp]{,} the ``par. IK''-method should be preferred.
...
\end{equation}
%
can be used to test the implementation, if (\ref{equ:alpha_xyz_diff_R}, \ref{equ:rotmat_diff_beta}) are defined for the same Euler-angle \todo[color=red!40]{Terminology}\replaced[id=Sp]{convention}{notation}.
