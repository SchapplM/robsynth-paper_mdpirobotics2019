...
\begin{figure}[H]
    ...
    \caption{Overview of the different frames (\textbf{a}) for six-DoF tasks with standard Euler angle \replaced[id=Sp]{convention}{notation} and (\textbf{b}) for five-DoF tasks with reciprocal Euler angle \replaced[id=Sp]{convention}{notation}; adapted from \cite{1_SchapplerTapOrt2019}.}
