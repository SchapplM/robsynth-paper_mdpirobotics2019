...
\history{Received: 27 June 2019; Accepted: 1 August 2019; Published: 6 August 2019}
...
\newcommand{\orcidauthorA}{0000-0001-7952-7363} % Add \orcidA{} behind the author's name
\newcommand{\orcidauthorB}{0000-0002-2473-0759} % Add \orcidB{} behind the author's name

% Authors, for the paper (add full first names)
\Author{Moritz Schappler *\href{https://orcid.org/0000-0001-7952-7363}{\orcidicon}, Svenja Tappe\href{https://orcid.org/0000-0002-2473-0759}{\orcidicon} and Tobias Ortmaier}
...
\address[1]{%
Institute of Mechatronic Systems, Leibniz University Hannover, 30167 Hannover, Germany}%Please check if the writing of the adress is ok.
...
\vspace{0.2cm} % to account for captions in the pdf_tex file, which are outside the lower border of the image
\caption{Typical mechanisms of the different classes. Adapted from \cite{ZhangGos2001} (\textbf{a}), \cite{MbarekNefCor2005} (\textbf{b}), \cite{AlaghebandMahMilBen2015} (\textbf{c}), \cite{Tale-MasoulehGos2011} (\textbf{d}).}
...
Figure\,\ref{fig:pkm_constr_rot_lead}b,c show cases, where the translational constraints are met, but the rotational constraints have different values.
For~3T3R tasks, only Figure\,\ref{fig:pkm_constr_rot_lead}c represents a valid solution of the inverse kinematics. For 3T2R tasks, \linebreak Figure\,\ref{fig:pkm_constr_rot_lead}b,c represent valid solutions.
...
The first evaluation of the IK algorithm from Section\,\ref{sec:ZB_Anwendung_IK_grad} is performed with simulations at the basic example of a six-DoF industrial robot with a $500\,\mathrm{mm} \times 800\,\mathrm{mm}$ rectangular trajectory centered at $1200$\,mm/$-200$\,mm/$200$\,mm with a constant orientation of the $z$-axis pointing into the ground plane.
...
\includegraphics[height=3cm]{serrob_traj_zero_pose_crop.png}
\end{minipage}
\end{tabular}
...
The histograms show that for the worst case in 3T2R (3T3R) tasks, the success rate is 87\% (6\%), marked by the position of the first bars in Figure\,\ref{fig:serrob_ik_hist_cdf}a,c.
...
Beginning at the bottom, the number of tries necessary for the solution of the IKP is marked with colors from green to orange.
...
Appendix\,\ref{sec:appendix_eulerreciproc} contains a mathematical proof for the properties of reciprocal Euler angles in inverse kinematics, which is only outlined in equ.\,18 of \cite{1_SchapplerTapOrt2019}.
The relations of the partial derivatives to the geometric and analytic Jacobian are derived in Appendixes\,\ref{sec:appendix_rotmatjacobian} and \ref{sec:appendix_gradient_geomjacobian}.
The matrix operations for the partial derivatives are replicated from \cite{1_SchapplerTapOrt2019} in Appendix \,\ref{sec:appendix_gradient_matrix} and the contents of the single partial derivatives are given in Appendix\,\ref{sec:appendix_content_derivatives} to facilitate the understanding and implementation by the reader.
...
\end{equation}
%
%and then exploiting the symmetry of second derivatives (Schwarz's theorem). --> unclear if this is correct
...
\end{equation}
%
Applying again the chain rule for differentiation of the function composition of the three functions $\overline{\prod}$ (matrix product), $\bm{S}$ (cross product matrix) and $\bm{\omega}_E$ (linear relation of velocities), as practiced in Section\,\ref{sec:ZB_Anwendung}, yields
%
\begin{equation}
\frac{\partial}{\partial \bm{q}_1}
\rotmato{0}{E}
...
The third factor is the rotational part of the geometric Jacobian.
This completes the calculation of the gradient matrix (\ref{equ:grad_Phi_1_q}) for the Euler angles orientation residual, which was first introduced, but not pursued further in \cite{GoldenbergBenFen1985}.
...
\newblock  Presented at the International Conference on Integrated Design and Manufacturing in Mechanical Engineering, Montreal, QC, Canada, 16--19 May  2000; note: the paper is not part of the conference proceedings published by Springer. Available online: \url{https://www.researchgate.net/profile/Luc\_Baron} (accessed on 2  August  2019).
...
{\bf 2005}, {\em 29},~679--690.
 [\href{http://dx.doi.org/10.1139/tcsme-2005-0045}{CrossRef}]

\bibitem[Žlajpah(2017)]{Zlajpah2017}
Žlajpah, L.
\newblock On orientation control of functional redundant robots.
\newblock  In Proceedings of the IEEE International Conference on Robotics and Automation (ICRA), Singapore,  29 May--3 June 2017; pp. 2475--2482.
 [\href{http://dx.doi.org/10.1109/ICRA.2017.7989288}{CrossRef}]

\bibitem[Léger and Angeles(2016)]{LegerAng2016}
Léger, J.; Angeles, J.
\newblock Off-line programming of six-axis robots for optimum five-dimensional
tasks.
\newblock {\em \mbox{Mech. Mach. Theory}} {\bf 2016}, {\em 100},~155--169.
 [\href{http://dx.doi.org/10.1016/j.mechmachtheory.2016.01.015}{CrossRef}]
...
\newblock  In \emph{Advances in Mechanism and Machine Science, Proceedings of  the 15th IFToMM World Congress on Mechanism and Machine Science, Kraków, Poland, 30 June--4 July 2019;} Springer: Berlin, Germany; 2019; Volume 73, pp. 1701--1710. [\href{http://dx.doi.org/10.1007/978-3-030-20131-9_168}{CrossRef}]

\bibitem[Yoshikawa(1984)]{Yoshikawa1984}
Yoshikawa, T.
\newblock Analysis and control of robot manipulators with redundancy.
\newblock  In \emph{Robotics Research: The 1st International Symposium}; MIT Press: Cambridge, MA, USA, 1984; pp. 735--747; ISBN 0262022079. %symposium held at Bretton Woods, N.H., Aug. 25--Sept. 2, 1983.
...
\newblock {\em IEEE J. Robot. Autom.} {\bf 1985}, {\em
1},~14--20.
 [\href{http://dx.doi.org/10.1109/JRA.1985.1086995}{CrossRef}]
...
{\bf 2013}, {\em 68},~2535--2545.
 [\href{http://dx.doi.org/10.1007/s00170-013-4873-5}{CrossRef}]
...
applications.
\newblock {\em Robot.~Comput. Integr. Manuf.} {\bf
2015}, {\em 27},~367--376.
 [\href{http://dx.doi.org/10.1016/j.rcim.2015.02.006}{CrossRef}]
...
{\bf 2011}, {\em 57},~1107--1121.
 [\href{http://dx.doi.org/10.1007/s00170-011-3349-8}{CrossRef}]
...
\newblock {\em \mbox{Mech. Mach. Theory}} {\bf 2011}, {\em 46},~831--844.
 [\href{http://dx.doi.org/10.1016/j.mechmachtheory.2011.01.009}{CrossRef}]
...
\newblock {\em J. Robot. Syst.} {\bf 2000}, {\em 17},~403--415. [\href{http://dx.doi.org/10.1002/1097-4563(200008)17:8<403::AID-ROB1>3.0.CO;2-J}{CrossRef}]
...
\newblock {\em J. Robot. Syst.} {\bf 1997}, {\em 14},~851--869.
\newblock
 [\href{http://dx.doi.org/10.1002/(SICI)1097-4563(199712)14:12<851::AID-ROB3>3.0.CO;2-T}{CrossRef}]
...
\newblock {\em J. Mech. Des.} {\bf 2001}, {\em 123},~375--381.
 [\href{http://dx.doi.org/10.1115/1.1370976}{CrossRef}]
...
\newblock  In~Proceedins of the IEEE International Conference on Mechatronics and Automation, Niagara Falls, ON, Canada, \mbox{29 July--1 August 2005}; Volume 3, pp. 1381--1385.
 [\href{http://dx.doi.org/10.1109/ICMA.2005.1626755}{CrossRef}]
...
\newblock  In Proceedings of the IEEE International Conference on Intelligent Mechatronics and Automation, Chengdu, China, 26--31 August 2004; pp. 304--308.
 [\href{http://dx.doi.org/10.1109/ICIMA.2004.1384209}{CrossRef}]
...
\newblock {\em Mechatronics} {\bf 2015}, {\em 30},~107--115.
\newblock
 [\href{http://dx.doi.org/10.1016/j.mechatronics.2015.06.014}{CrossRef}]
...
robot.
\newblock {\em \mbox{Robot. Auton. Syst.}} {\bf 2016}, {\em 79},~12--25.
 [\href{http://dx.doi.org/10.1016/j.robot.2016.02.002}{CrossRef}]
...
\newblock {\em VDI-Berichte Nr. 1892} {\bf 2005}.
\newblock  Available online:
\url{https://www.igmr.rwth-aachen.de/index.php/en/rob-en/rob-pentapod-en} (accessed on 20
June  2019). (In German)
...
\newblock
 [\href{http://dx.doi.org/10.1016/S0094-114X(03)00007-7}{CrossRef}]
...
\newblock {\em Int. J. Adv. Manuf.~Technol.}
{\bf 2006}, {\em 31},~201.
 [\href{http://dx.doi.org/10.1007/s00170-005-0171-1}{CrossRef}]

\bibitem[Bär and Weiß(2006)]{BaerWei2006}
Bär, G.F.; Weiß, G.
\newblock Kinematic Analysis of a Pentapod Robot.
\newblock {\em J. Geometry   Graph.} {\bf 2006}, {\em
10},~173--182.
...
\newblock {\em Int. J. Adv. Robot. Syst.} {\bf 2013},
{\em 10},~314.
\newblock
 [\href{http://dx.doi.org/10.5772/54966}{CrossRef}]
...
machine.
\newblock {\em J. Mech. Robot.} {\bf 2015}, {\em 7},~034502.
\newblock
 [\href{http://dx.doi.org/10.1115/1.4028933}{CrossRef}]

\bibitem[Gogu(2006)]{Gogu2006}
Gogu, G.
\newblock Fully-isotropic parallel manipulators with five degrees of freedom.
\newblock {In Proceedings of the 2006 IEEE International Conference on Robotics and Automation, Orlando, FL, USA, 15--19 May 2006;} IEEE: Piscataway, NJ, USA, 2006; pp. 1141--1146.
\newblock
 [\href{http://dx.doi.org/10.1109/ROBOT.2006.1641863}{CrossRef}]
...
\newblock  {\em Int. J. Robot. Res.} {\bf 2002}, {\em 21},~131--145.
\newblock
 [\href{http://dx.doi.org/10.1177/027836402760475342}{CrossRef}]

\bibitem[Kong and Gosselin(2005)]{KongGos2005}
Kong, X.; Gosselin, C.M.
\newblock Type synthesis of 5-DOF parallel manipulators based on screw theory.
\newblock {\em \mbox{J. Robot. Syst.}} {\bf 2005}, {\em 22},~535--547.
\newblock
 [\href{http://dx.doi.org/10.1002/rob.20084}{CrossRef}]
...
\newblock  In Proceedings of the ASME International Design Engineering Technical Conferences and
Computers and Information in Engineering Conference, Montreal,  QC, Canada,   15--18 August 2010; pp. 1335--1344.
\newblock
 [\href{http://dx.doi.org/10.1115/DETC2010-28509}{CrossRef}]
...
redundant actuation.
\newblock  In {\em Intelligent Robotics and Applications, Proceedings of the International Conference on Intelligent Robotics and Applications, Wuhan, China, 15--17 October 2008;} Springer: Berlin, Germany, 2008; pp.~179--188.
\newblock
 [\href{http://dx.doi.org/10.1007/978-3-540-88513-9_20}{CrossRef}]
...
\newblock   In Proceedings of the  14th IFToMM World Congress, Taipeh, Taiwan,   25--30  October 2015;
\newblock
 [\href{http://dx.doi.org/10.6567/IFToMM.14TH.WC.OS13.047}{CrossRef}]
...
\newblock {\em Ind. Robot.} {\bf 2008}, {\em
35},~456--464.
 [\href{http://dx.doi.org/10.1108/01439910810893626}{CrossRef}]
