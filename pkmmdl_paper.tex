...
The U\underline{P}S structure is used for the six-DoF part of the mechanism 
  ...
  by \cite{ZhangGos2001} with a focus on kinetostatic modeling at the example of 5U\underline{P}S/RUU, 
...
It contains the
  Metrom machine tool (4S\underline{P}RR-S\underline{P}R), which is analyzed regarding inverse and forward kinematics in \cite{BaerWei2006} or its variants, 
...
%\vspace{-5.7cm} % Damit Textende näher an Fußnote kommt (funktioniert nicht.)
\begin{figure}[b]
	\vspace{-0.7cm} % Damit Bild näher von unten an Fußnote kommt
