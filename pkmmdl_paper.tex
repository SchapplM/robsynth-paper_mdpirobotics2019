...
The 3T2R algorithm without nullspace optimization is plotted with dotted lines for each of the 3T3R cases with the same colors.
Using these initial values for a 3T2R IK with optimization leads to strong nullspace movements quickly converging to a local minimum.
