...
\vspace{0.3cm} % to account for captions in the pdf_tex file, which are outside the lower border of the image
...
\includegraphics[width=4.5 cm]{serrob_traj_zero_pose.png} % left bottom right top
\end{minipage}
\end{tabular}
