...
Additionally, the Denavit Hartenberg parameters were set to 50 different sets of uniformly distributed parameters between $0$ and $1$ meters or radians resulting to 2500 combinations for each of the 309 chains in total.
%The motivation for this test set is to investigate the IK algorithm in a worst case scenario
The inital value $\bm{q}^0$ for the solution of the IKP of (\ref{equ:IK_damping}) was set to random values from a uniform distribution within the joint limits.
